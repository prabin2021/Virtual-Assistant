...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        cv2.imwrite("D:/Github_Uploaded/jarwis2/Face_Verification/Face_samples/face." + str(face_id) + '.' + str(count) + ".jpg", converted_image[y:y+h,x:x+w])
    ...
    if k == 27: # Press 'ESC' to stop
        break
    elif count >= 350: # Take 50 sample (More sample --> More accuracy)
         break
